package iris.platform.shop.velocity;
...
import iris.platform.shop.velocity.boot.web.EmbeddedVelocityViewResolver;
import iris.platform.shop.velocity.support.VelocityEngineFactory;
import iris.platform.shop.velocity.support.VelocityEngineFactoryBean;
/**
 * @author xinguiyuan
